...
import 'package:talktsy/utils/custom_http_client.dart';
import 'package:talktsy/utils/init_with_restore.dart';
import 'package:talktsy/utils/platform_infos.dart';
import 'package:universal_html/html.dart' as html;
import 'package:get/get.dart';
import 'package:talktsy/utils/custom_image_resizer.dart';
import 'package:talktsy/utils/matrix_sdk_extensions/flutter_hive_collections_database.dart';
import 'matrix_sdk_extensions/flutter_matrix_dart_sdk_database/builder.dart';
import 'package:flutter_gen/gen_l10n/l10n.dart';

abstract class ClientManager {
  static const String clientNamespace = 'im.talktsy.store.clients';
          ...
          (client) => client.initWithRestore(
            onMigration: () {
              sendInitNotification(
                L10n.of(Get.context!)?.databaseIsOptimized ?? "",
                L10n.of(Get.context!)?.databaseMigrationBody ?? "",
              );
            },
          ).catchError(
  ...
  static Client createClient(String clientName) {
    return Client(
      clientName,
      httpClient:
          Platform.isAndroid ? CustomHttpClient.createHTTPClient() : null,
      verificationMethods: {
